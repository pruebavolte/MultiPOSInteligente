...
SELECT temp_insert_vertical('restaurants', 'food_truck', 'food-truck', 'Food Truck', 'Food Truck', 'Cocina móvil sobre ruedas', 'Truck', 'FoodTruckPos', 'foodtruck', 80, 21, 'Cliente', 'Clientes', 'Platillo', 'Platillos', 'Orden', 'Órdenes', ARRAY['pos', 'inventory', 'reports'], ARRAY['digital_menu', 'queue_management'], ARRAY[]);
...
SELECT temp_insert_vertical('fashion', 'boutique_novias', 'boutique-novias', 'Boutique de Novias', 'Bridal Shop', 'Vestidos de novia y accesorios', 'Heart', 'NoviasPos', 'novias', 55, 10, 'Novia', 'Novias', 'Vestido', 'Vestidos', 'Pedido', 'Pedidos', ARRAY['pos', 'inventory', 'customers', 'reports'], ARRAY['appointments', 'reservations'], ARRAY[]);
...
SELECT temp_insert_vertical('technology', 'reparacion_celulares', 'reparacion-celulares', 'Reparación de Celulares', 'Phone Repair', 'Servicio técnico de celulares', 'Wrench', 'ReparacionCelPos', 'reparacioncel', 80, 3, 'Cliente', 'Clientes', 'Reparación', 'Reparaciones', 'Servicio', 'Servicios', ARRAY['pos', 'inventory', 'customers', 'reports'], ARRAY['appointments', 'serial_numbers'], ARRAY[]);
...
SELECT temp_insert_vertical('health', 'optica', 'optica', 'Óptica', 'Optical Shop', 'Lentes y servicios ópticos', 'Eye', 'OpticaPos', 'optica', 80, 3, 'Paciente', 'Pacientes', 'Lentes', 'Lentes', 'Venta', 'Ventas', ARRAY['pos', 'inventory', 'customers', 'reports'], ARRAY['appointments', 'product_variants'], ARRAY[]);
SELECT temp_insert_vertical('health', 'consultorio_medico', 'consultorio-medico', 'Consultorio Médico', 'Medical Office', 'Consultorio médico general', 'Stethoscope', 'ConsultorioPos', 'consultorio', 75, 4, 'Paciente', 'Pacientes', 'Consulta', 'Consultas', 'Cita', 'Citas', ARRAY['pos', 'customers', 'reports'], ARRAY['appointments', 'staff_management'], ARRAY[]);
...
SELECT temp_insert_vertical('health', 'spa', 'spa', 'Spa', 'Spa', 'Centro de relajación y bienestar', 'Flower', 'SpaPos', 'spa', 75, 6, 'Cliente', 'Clientes', 'Tratamiento', 'Tratamientos', 'Sesión', 'Sesiones', ARRAY['pos', 'inventory', 'customers', 'reports'], ARRAY['appointments', 'staff_management', 'loyalty_program'], ARRAY[]);
