...
DROP POLICY IF EXISTS "Users can view their restaurant's ingredients" ON ingredients;
CREATE POLICY "Users can view their restaurant's ingredients"
  ON ingredients FOR SELECT
  USING (true);

DROP POLICY IF EXISTS "Users can insert ingredients for their restaurant" ON ingredients;
CREATE POLICY "Users can insert ingredients for their restaurant"
  ON ingredients FOR INSERT
  WITH CHECK (true);

DROP POLICY IF EXISTS "Users can update their restaurant's ingredients" ON ingredients;
CREATE POLICY "Users can update their restaurant's ingredients"
  ON ingredients FOR UPDATE
  USING (true);

DROP POLICY IF EXISTS "Users can delete their restaurant's ingredients" ON ingredients;
...
DROP POLICY IF EXISTS "Users can view recipes for their restaurant's products" ON recipes;
CREATE POLICY "Users can view recipes for their restaurant's products"
  ON recipes FOR SELECT
  USING (true);

DROP POLICY IF EXISTS "Users can insert recipes for their restaurant's products" ON recipes;
CREATE POLICY "Users can insert recipes for their restaurant's products"
  ON recipes FOR INSERT
  WITH CHECK (true);

DROP POLICY IF EXISTS "Users can update recipes for their restaurant's products" ON recipes;
CREATE POLICY "Users can update recipes for their restaurant's products"
  ON recipes FOR UPDATE
  USING (true);

DROP POLICY IF EXISTS "Users can delete recipes for their restaurant's products" ON recipes;
...
DROP POLICY IF EXISTS "Users can view their restaurant's inventory transactions" ON inventory_transactions;
CREATE POLICY "Users can view their restaurant's inventory transactions"
  ON inventory_transactions FOR SELECT
  USING (true);

DROP POLICY IF EXISTS "Users can insert inventory transactions for their restaurant" ON inventory_transactions;
