...
export function DigitalizeMenuDialog({
  ...
  const processImages = async () => {
    ...
    try {
      ...
      // Add the generateAIImages parameter to the form data
            ...
            if (line.startsWith('data: ')) {
              try {
                ...
                if (data.type === 'analyzing') {
                  ...
                  setProcessingStep(`🎨 Generando imagen: ${data.productName}`);
            ...
            <>
              ...
              <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                <div className="space-y-0.5">
                  <Label htmlFor="ai-images" className="text-sm font-medium cursor-pointer">
                    Generar imágenes con IA
                  </Label>
                  <p className="text-xs text-muted-foreground">
                    Crea imágenes automáticas para cada producto
                  </p>
                </div>
                <Switch
                  id="ai-images"
